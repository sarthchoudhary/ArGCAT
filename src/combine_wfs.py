...
output_path = path.join(data_dir, f'event_catalogue_combinedrun{run_name}.pkl')
...
file_00 =  path.join(data_dir, 'event_catalogue_run00152_00.pkl')
file_00 = pd.read_pickle(file_00)['wf']
file_01 =  path.join(data_dir, 'event_catalogue_run00152_01.pkl')
